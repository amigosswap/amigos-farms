...
interface IMasterChef {
    ...
    function pendingAmi(uint256 _pid, address _user) external view returns (uint256);
...
// File: contracts/AmigosVault.sol

pragma solidity 0.6.12;

contract AmigosVault is Ownable, Pausable {
    ...
    function calculateHarvestCakeRewards() external view returns (uint256) {
        uint256 amount = IMasterChef(masterchef).pendingAmi(0, address(this));
